...
public abstract class Controller {
    ...
    //EFFECTS:
	public void goToEventsPage(ActionEvent event, Event outEvent) throws IOException {
        ...
        controller.initialize(outEvent);
    ...
    public void goToNewEventPage(ActionEvent event) throws IOException {
        FXMLLoader loader = new FXMLLoader(getClass().getResource("/newEvent/NewEvent.fxml"));
        Parent parent = loader.load();
        Scene page = new Scene(parent);
